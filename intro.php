      ...
      <div class="span7">
        <div class="widget-block">
          <div class="widget-head">
            <h5> INTRODUCTION
          </h5></div><div class="widget-content"><div class="widget-box"><form class="well"><div class="controls"><p>Dear Parent,</p>
                  <p>We invite you to complete the Autism Research Institute’s (ARI) online questionnaire.   Autism is a heterogeneous condition, and we hope the results from this questionnaire will provide insight into understanding and treating those on the autism spectrum.</p>
                  <p>Background.  The questionnaire is actually a revised version of ARI’s Diagnostic Checklist Form E-2.  As many of you may know, Dr. Bernard Rimland, autism pioneer and founder of ARI, developed the checklist in the 1960s.  The first version, E-1, appeared as an appendix in his seminal 1964 book Infantile Autism: The Syndrome and Its Implications for a Neural Theory of Behavior.   Soon after the publication of the book, parents wrote to Dr. Rimland to share their own child’s developmental history along with descriptions of their behaviors; within a year or two, Dr. Rimland revised the checklist.  This year we added more questions to the E-2 because much has been learned over the past 50 years.</p>
                  <p>Dr. Rimland created the E-2 checklist to diagnose classical autism, or Kanner’s syndrome, as well as to subtype autism.  Over 42,000 parents worldwide have completed the E-2 checklist, and we recently analyzed the data in relation to subgroups.  The tentative findings indicate that there may be 10 to 12 types of autism. As with any research study, of course, these results need to be replicated. </p>
                  ...
                  <p>Instructions.  The questionnaire should be completed by a parent or guardian who has one or more children on the autism spectrum.   In addition, your son/daughter needs to be at least three years of age and formally diagnosed with autism, Asperger’s syndrome, or pervasive developmental disorder (PDD). </p>
              ...
              <form class="well white-box">
                <fieldset>
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" class="input-xlarge text-tip" id="input801" title="Enter your email address.">
                      <!--<p class="help-block"> In addition to freeform text, any HTML5 text-based input appears like so. </p>-->
                    </div>
                  </div>
                  <div class="control-group">
                    <label class="control-label" for="input803">Pin*</label>
                    <div class="controls">
                      <input type="password" class="input-xlarge text-tip" id="input803" title="Enter 4 number pin (Required)" maxlength="4">
                      <!--<p class="help-block"> In addition to freeform text, any HTML5 text-based input appears like so. </p>-->
                    </div>
                  </div>
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" class="input-xlarge text-tip" id="input802" title="Enter your full name (optional).">
                      <!--<p class="help-block"> In addition to freeform text, any HTML5 text-based input appears like so. </p>-->
                    </div>
                  </div>
                  <div class="control-group">
                  ...
                  <div class="form-actions">
                    <button type="submit" class="btn btn-primary">Save & Begin</button>
