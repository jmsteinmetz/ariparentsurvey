          ...
          <div class="widget-box" style="display:table">
            ...
            <?php include("inc/note.php"); ?>
              <form id="arisurvey" >
                ...
                <div id="form-submit" class="field f_100 clearfix submit" style="margin-bottom:25px"> <a href="step15.php?token=<?php echo $token ?>" class="btn btn-primary">Next Page</a> </div>
              </form>
            <?php include("inc/note.php"); ?>
            </div>
          </div>
