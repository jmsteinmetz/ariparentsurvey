              ...
              <form id="arisurvey" >
                ...
                <div id="field1-container" class="field f_100 radio-group">
                  ...
                  <div class="option clearfix">
                    ...
                    <input data="1. Present age of child if over 6" name="field1b" class="numeral" required type="text">
                    years)<br>
                ...
                <div id="field3-container" class="field f_100 radio-group required">
                  ...
                  <div class="option clearfix">
                    <input data="3. Child's birth order and number of mother's other children:" name="field3a" value="Only child" type="radio">
                    <span class="option-title"> Child is an only child </span> </div>
                  <div class="option clearfix">
                    <input data="3. Child's birth order and number of mother's other children:" name="field3a" id="" value="first born" type="radio">
                    <span class="option-title"> Child is first born of
                    <input data="3. Number of mother's other children:" name="field3a1" type="text" class="numeral" id="">
                    children </span> </div>
                  <div class="option clearfix">
                    <input data="3. Child's birth order and number of mother's other children:" name="field3a" id="" value="last born" type="radio">
                    <span class="option-title"> Child is last born of
                    <input data="Child is last born of" name="field3b1" type="text" class="numeral" id="">
                    children </span> </div>
                  <div class="option clearfix">
                    <input data="3. Child's birth order and number of mother's other children:" name="field3a" id="" value="Child is middle born" type="radio">
                    <span class="option-title">Child is middle born;
                    <input data="siblings older than child" name="field3c1" id="" type="text" class="numeral" maxlength="4">
                    children are older and
                    <input data="siblings younger than child" name="field3d2" id="" type="text" class="numeral" maxlength="4">
                    are younger than this child</span> </div>
                  <input data="3. Child's birth order and number of mother's other children:" name="field3a" id="" value="Foster child or don't know." type="radio">
                ...
                <div id="field5-container" class="field f_100 radio-group required">
                  ...
                  <div class="option clearfix">
                    ...
                    <input data="# of weeks premature" name="field5a1" id="" type="text" class="numeral">
                    weeks early;
                    <input data="# of pounds" name="field5a2" id="" type="text" class="numeral">
                    pounds</span> </div>
                  <div class="option clearfix">
                ...
                <div id="field6-container" class="field f_100 radio-group required">
                  ...
                  <div class="option clearfix">
                    <input data="6. Was the child given oxygen in the first week?" name="field6a" id="" value="Yes" type="radio">
                    <span class="option-title"> Yes </span> </div>
                  <div class="option clearfix">
                    <input data="6. Was the child given oxygen in the first week?" name="field6a" id="" value="No" type="radio">
                    <span class="option-title"> No </span> </div>
                  <div class="option clearfix">
                    <input data="6. Was the child given oxygen in the first week?" name="field6a" id="" value="Don't know" type="radio">
                    <span class="option-title"> Don't know </span> </div>
                </div>
                ...
                <div id="field8-container" class="field f_100 radio-group">
                  ...
                  <div class="option clearfix">
                    <input data="8. Unusual conditions of birth and infancy" name="field8a" id="" value="Unusual Conditions"  type="radio">
                    <em> 1.</em><span class="option-title"> Unusual conditions (indicate which: </span></div>
                  <div class="option clearfix spaceindent">
                    <input data="8. Unusual conditions of birth and infancy: blindness" name="field8" id="field8a1" type="checkbox" value="true">
                    <span class="option-title">blindness, </span></div>
                  <div class="option clearfix spaceindent">
                    <input data="8. Unusual conditions of birth and infancy: cerbral palsey" name="field8" id="field8a2" type="checkbox" value="true">
                    <span class="option-title">cerbral palsey, </span></div>
                  <div class="option clearfix spaceindent">
                    <input data="8. Unusual conditions of birth and infancy: birth injury" name="field8" id="field8a3" type="checkbox" value="true">
                    <span class="option-title">birth injury, </span></div>
                  <div class="option clearfix spaceindent">
                    <input data="8. Unusual conditions of birth and infancy: seizures" name="field8" id="field8a4" type="checkbox" value="true">
                    <span class="option-title">seizures, </span></div>
                  <div class="option clearfix spaceindent">
                    <input data="8. Unusual conditions of birth and infancy: blue baby" name="field8" id="field8a5" type="checkbox" value="true">
                    <span class="option-title">blue baby, </span></div>
                  <div class="option clearfix spaceindent">
                    <input data="8. Unusual conditions of birth and infancy: very high fever" name="field8" id="field8a6" type="checkbox" value="true">
                    <span class="option-title">very high fever, </span></div>
                  <div class="option clearfix spaceindent">
                    <input data="8. Unusual conditions of birth and infancy: jaundice" name="field8" id="field8a7" type="checkbox" value="true">
                    <span class="option-title">jaundice,</span></div>
                  <div class="option clearfix spaceindent">Other:
                    <input data="8. Unusual conditions of birth and infancy: Other" name="field8" id="field8a8" type="text" maxlength="25">
                  </div>
                  <div class="option clearfix radio-group">
                    <input data="8. Unusual conditions of birth and infancy" name="field8a" id="" value="Twin Birth"  type="radio">
                    <span class="option-title"><em> 2.</em> Twin Birth (
                    <input data="Type of Twins" name="field8b1" id="" type="radio" value="identical"> identical,
                    <input data="Type of Twins" name="field8b1" id="" type="radio" value="fraternal"> fraternal)
                    </span> </div>
                  <div class="option clearfix">
                    <input data="8. Unusual conditions of birth and infancy" name="field8b1" id="" value="Both unusual conditions and twins" type="radio">
                    <em><span class="option-title"> 3.</span></em><span class="option-title"> Both 1 and 2</span> </div>
                  <div class="option clearfix">
                    <input data="8. Unusual conditions of birth and infancy" name="field8b1" id="" value="Average, don't know, or other"  type="radio">
                ...
                <div id="field9-container" class="field f_100 radio-group">
                  ...
                  <div class="option clearfix">
                    <input data="9. Concerning baby's health in first 3 months" name="field9a" id="" value="Respiration: Frequent Infections" type="radio">
                    <span class="option-title"> <em>2.</em> Respiration (
                    <input data="Respiration: frequent infections" name="field9" id="field9b1" type="checkbox" value="true">frequent infections,
                    <input data="Respiration: other" name="field9" id="field9b2" type="text">other) </span> <br>
                  </div>
                  <div class="option clearfix">
                    <input data="9. Concerning baby's health in first 3 months" name="field9a" id="field9c" value="Skin: Rashes" type="radio">
                    <em><span class="option-title"> 3</span></em><span class="option-title">. Skin (
                    <input data="9. Concerning baby's health in first 3 months: rashes" name="field9" id="field9c1" type="checkbox" value="true">
                    rashes,
                    <input data="9. Concerning baby's health in first 3 months: infections" name="field9" id="field9c2" type="checkbox" value="true">
                    infections,
                    <input data="9. Concerning baby's health in first 3 months: allergy" name="field9" id="field9c3" type="checkbox" value="true">
                    allergy,
